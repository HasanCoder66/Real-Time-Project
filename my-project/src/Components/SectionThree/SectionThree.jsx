...
const SectionThree = () => {
  return (
    ...
    <div className="md:pr-[200px] md:pl-[200px] mb-[2rem]">
      ...
      <p className="md:pr-[200px] md:pl-[200px] font-semibold text-center">Tap into a more extensive audience base through our web designs!</p>
      <p className="md:pr-[100px] md:pl-[100px] text-center text-black">Webdeezien has a team of expert web developers, designers, and product engineers who deal with complex tasks ranging from eCommerce to real estate and other diverse industries, improving the user experience, functionality, and performance. We have always devised result-driven approaches in NYC to gain traffic and increase customer loyalty. This puts us in a better position to create a website according to the client's specific needs and provide valuable insights for their business.</p>
    </div>
