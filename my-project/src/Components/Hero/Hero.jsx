...
const Hero = () => {
  ...
  return (
    <div className='h-[88vh] bg-[url("https://res.cloudinary.com/dpvxkqhi8/image/upload/v1708534584/branding%20hopes/banner_b0pbcx.jpg")] bg-cover bg-center bg-[#18252b]'>
      ...
      <div className='w-[100%] h-[100%] flex items-center justify-between overflow-hidden ' ref={ref}>
        {/* =========================== */}
        ...
        <motion.div style={{ x: yText3 }} className='w-[100%] bg-[url("https://res.cloudinary.com/dpvxkqhi8/image/upload/v1709738846/branding%20hopes/stars_w1as7l.png")] bg-repeat bg-repeat-x bg-cover h-[100%] absolute top-[120px] right-[0px] left-[0px] bottom-[0px] opacity-[30%]'></motion.div>
        {/* ============================ */}
      </div>
    </div>
  );
